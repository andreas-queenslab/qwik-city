...
export default component$(() => {
  ...
  return (
    <>
      ...
      <ul>
        <li>
          <Anchor href="/products/jacket">Jacket</Anchor>
        </li>
        <li>
          <Anchor href="/products/hat">Hat</Anchor>
        </li>
        <li>
          <Anchor href="/products/shirt">
            T-Shirt (Redirect to /products/tshirt)
          </Anchor>
        </li>
        <li>
          <Anchor href="/products/hoodie">Hoodie (404 Not Found)</Anchor>
        </li>
      </ul>
    </>
  );
